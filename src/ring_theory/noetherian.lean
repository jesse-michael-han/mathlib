...
begin
  ...
  refine mem_sup.2 ⟨lc.total β α β id ((lc.map α id id g : lc γ α γ id → lc β α β id) l), _,
    x - lc.total β α β id ((lc.map α id id g : lc γ α γ id → lc β α β id) l), _, add_sub_cancel'_right _ _⟩,
